    ...
    return (
        <>
            <div className='flex flex-col gap-5 justify-center items-center md:mt-20 '>
                ...
                <button onClick={() => handleClick("/booking/custom")} className="bg-primary w-[75%] md:w-[60%] rounded-md py-2 hover:scale-105 active:scale-100 transition ease-in-out duration-150"><p className="font-bold">Je veux un tatouage perso !</p></button>
            </div>
        </>
    )
}
