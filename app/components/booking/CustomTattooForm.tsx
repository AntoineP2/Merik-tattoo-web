"use client"
import { CustomTattooFormInputs, DISPONIBILITY_ENUM, PLACEMENT_ENUM, TATTOO_SIZE_ENUM } from "@/utils/enum";
...
const CustomTattooForm = () => {
    ...
    const onSubmit: SubmitHandler<CustomTattooFormInputs> = (data) => {
        console.log(data);
    };
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col bg-base-200 rounded-lg shadow-sm p-4 shadow-primary gap-3">
                            ...
                            <div>
                                {/*Taille*/}
                                <div className="flex justify-center items-center pt-2 pb-2 md:justify-start">
                                    <h2 className="text-md font-bold text-accent md:ml-2"> Taille du Tattoo</h2>
                                </div>
                            ...
                            <div className="pt-5">
                                ...
                                {errors.description?.type === "pattern" && (
                                    <span className="text-error text-xs">
                                        La référence doit être composée de lettre et de chiffre uniquement
                                    </span>
                                )}
                            </div>
                        </div>
