...
export const careList: CareListType[] = [
  {
    ...
    icon: <MdOutlineCleanHands className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <FaWind className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <IoWater className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <TbSunOff className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <GiTripleScratches className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <GiHotSurface className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <GiClothes className="text-primary" size={20} />,
    description:
  ...
  },
  {
    ...
    icon: <IoCallSharp className="text-primary" size={20} />,
    description:
